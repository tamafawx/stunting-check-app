...
class DetailBalitaBidanScreen extends StatefulWidget {
  final String docId;
  final Map<String, dynamic> data;
  const DetailBalitaBidanScreen({
    super.key,
    required this.docId,
    required this.data,
  });
  ...
  @override
  State<DetailBalitaBidanScreen> createState() =>
      _DetailBalitaBidanScreenState();
}

class _DetailBalitaBidanScreenState extends State<DetailBalitaBidanScreen>
                ...
                Container(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundColor: jenisKelamin == 'Laki-laki'
                        ? Colors.purple[50]
                        : Colors.pink[50], // Diubah dari biru ke ungu
                    child: CircleAvatar(
                      radius: 36,
                      backgroundColor: jenisKelamin == 'Laki-laki'
                          ? Colors.purple[100]
                          : Colors.pink[100], // Diubah dari biru ke ungu
                      ...
                      child: (fotoUrl == null || fotoUrl.isEmpty)
                          ? Icon(
                              ...
                              color: jenisKelamin == 'Laki-laki'
                                  ? Colors.purple[700]
                                  : Colors
                                        .pink[700], // Diubah dari biru ke ungu
                            )
                          : null,
                    ),
                  ),
  ...
  Widget _buildRingkasanTab(String idBalita) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (latestDoc['tanggal'] != null) {
          ...
          tglPemeriksaan = "${dt.day} ${_getMonthName(dt.month)} ${dt.year}";
        }
        ...
        String saranText =
            "Pertumbuhan balita terpantau normal. Pertahankan asupan gizi serta pola asuh.";
        ...
        if (statusStunting.toLowerCase().contains("risiko tinggi") ||
          ...
          saranText =
              "Tindakan medis direkomendasikan. Lakukan edukasi khusus gizi mikro pada keluarga.";
          ...
          saranText =
              "Pantau perkembangan secara berkala. Berikan asupan gizi tambahan (PMT) bila diperlukan.";
        }
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "Kurva Pertumbuhan WHO (Tinggi Badan / Usia)",
