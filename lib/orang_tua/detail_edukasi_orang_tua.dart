...
class DetailEdukasiOrangTuaScreen extends StatelessWidget {
  final Map<String, dynamic> data;

  const DetailEdukasiOrangTuaScreen({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // AppBar dibuat transparan (ditimpa oleh gambar cover)
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 12,
                                color: Colors.green, // Tema warna Orang Tua
                              ),
                            ),
                          ],
                        ),
