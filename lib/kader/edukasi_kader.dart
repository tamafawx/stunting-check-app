...
import 'detail_edukasi_kader.dart';

class EdukasiKaderScreen extends StatefulWidget {
  final String userId;
  final String fullName;

  const EdukasiKaderScreen({
    super.key,
  ...
  @override
  State<EdukasiKaderScreen> createState() => _EdukasiKaderScreenState();
}

class _EdukasiKaderScreenState extends State<EdukasiKaderScreen> {
  String _searchQuery = '';
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TambahEdukasiScreen(
