...
import 'percakapan_konsultasi_kader.dart';

class KonsultasiKaderScreen extends StatefulWidget {
  final String userId;
  final String fullName;

  const KonsultasiKaderScreen({
    super.key,
  ...
  @override
  State<KonsultasiKaderScreen> createState() => _KonsultasiKaderScreenState();
}
          ...
          child: ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ChatKonsultasiKaderScreen(
                    konsultasiId: doc.id,
