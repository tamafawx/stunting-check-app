...
class ChatKonsultasiKaderScreen extends StatefulWidget {
  final String konsultasiId;
  final String lawanBicaraName;
  final String currentUserId;

  const ChatKonsultasiKaderScreen({
    super.key,
  ...
  @override
  State<ChatKonsultasiKaderScreen> createState() =>
      _ChatKonsultasiKaderScreenState();
}

class _ChatKonsultasiKaderScreenState extends State<ChatKonsultasiKaderScreen> {
